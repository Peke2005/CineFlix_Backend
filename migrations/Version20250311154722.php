...
final class Version20250311154722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE actores (id_actor INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(45) NOT NULL, fecha_nacimiento DATE NOT NULL, nacionalidad VARCHAR(45) NOT NULL, PRIMARY KEY(id_actor)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE peliculas (id_pelicula INT AUTO_INCREMENT NOT NULL, paises_id INT DEFAULT NULL, titulo VARCHAR(45) NOT NULL, descripcion VARCHAR(45) NOT NULL, año DATE NOT NULL, duracion INT NOT NULL, portada VARCHAR(255) NOT NULL, trailer VARCHAR(255) NOT NULL, INDEX IDX_9B1814B0282BEA6A (paises_id), PRIMARY KEY(id_pelicula)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
