...
final class Version20250311154722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuarios (id_usuario INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(45) NOT NULL, email VARCHAR(45) NOT NULL, contraseña VARCHAR(60) NOT NULL, rol VARCHAR(45) NOT NULL, fecha_registro DATETIME NOT NULL, PRIMARY KEY(id_usuario)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
